  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative w-full">
        ...
        <div className="relative w-full">
          ...
          <img src="https://res.cloudinary.com/dmwuhogih/image/upload/v1773105988/Design_sem_nome_1_qppawg.png" alt="Acesse o material abaixo" className="w-full h-auto hidden md:block" />
        </div>
      </section>
